...
#define VX_DECLARE_PRIVATE(Class) \
	...
	inline [[nodiscard]]const Class##Private* d_func() const noexcept { return reinterpret_cast<const Class##Private*>(d_ptr); } \
	friend Class##Private;

#define VX_DECLARE_PUBLIC(Class) \
	inline Class* q_func() noexcept { return reinterpret_cast<Class*>(q_ptr); } \
	inline [[nodiscard]]const Class* q_func() const noexcept { return reinterpret_cast<const Class*>(q_ptr); } \
	friend Class;
